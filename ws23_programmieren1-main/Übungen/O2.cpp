...
{   
    ...
    void do_something()
    {
        ...
        for(size_t i = 0; i < list_of_presents.size(); ++i)
        {
            const present &current_present = list_of_presents[i]; // Get the current present
    ...
    present* take_present(size_t index)
    {
        if (index < list_of_presents.size())
        {
            ...
            cout << "STUPID ASS BUG TAKEN PRESENT:" << index << endl;
    ...
    void erase_present(size_t index)
    {
